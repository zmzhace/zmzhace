...
- **[🌱 SeedWorld](https://github.com/zmzhace/SeedWorld)**: 涌现式世界模拟引擎。给 LLM 一个世界设定，它自动生成角色、建立恩怨关系，然后放手——故事从混沌中自然生长。12 个机制系统（声誉、资源竞争、戏剧张力、模因传播...）形成 LLM 反馈闭环，角色的背叛、联盟、谈判全部涌现而非编排。"Plant a world. Watch it grow."
...
目前我正全力投入于 **[🌱 SeedWorld](https://github.com/zmzhace/SeedWorld)** —— 一个涌现式世界模拟引擎。核心理念：**不写故事，种故事**。
...
如果您对 **涌现式 AI 叙事**、**多 Agent 模拟**、或是 **LLM 驱动的世界构建** 感兴趣，非常欢迎交流！
...
- 💬 探讨方向: AI Agents, 涌现式模拟, RAG架构, Next.js / 全栈开发

---
<p align="right">
  <i>最后更新于: 2026-03-20 01:01:32</i>
</p>
